...
public class MethodExceptionHandler<T extends Throwable>
    ...
    protected MethodExceptionHandler(Class<T> exceptionClass, Priority priority, Object source, Method method) {
    ...
    public static MethodExceptionHandler of(Object source, Method method) {
        ...
        return new MethodExceptionHandler(exceptionClass, exceptionHandler.priority(), source, method);
    }
